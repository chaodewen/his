...
public class Assay {
    ...
    private Collection<AssayItem> assayItemsById;
    ...
    public Collection<AssayItem> getAssayItemsById() {
        return assayItemsById;
    }

    public void setAssayItemsById(Collection<AssayItem> assayItemsById) {
